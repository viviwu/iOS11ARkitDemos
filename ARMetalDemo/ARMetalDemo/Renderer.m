...
- (void)_updateSharedUniformsWithFrame:(ARFrame *)frame {
    ...
    uniforms->projectionMatrix = [frame.camera projectionMatrixWithViewportSize:_viewportSize orientation:UIInterfaceOrientationLandscapeRight zNear:0.001 zFar:1000];
...
- (void)_updateImagePlaneWithFrame:(ARFrame *)frame {
    ...
    CGAffineTransform displayToCameraTransform = CGAffineTransformInvert(
        [frame displayTransformWithViewportSize:_viewportSize orientation:UIInterfaceOrientationLandscapeRight]);
